...
//Dado un numero N imprimir la lista de todos los numero primos hasta dicho n�mero N.
...
public class Ejerciciosiete {
	...
	public static void main(String[] args) {
		...
		System.out.println("Introduce un n�mero mayor que 1 para conocer todos los n�meros primos hasta ese valor: ");
		int N = sc.nextInt();
		
		System.out.println("Los primos menores que " + N + " son: ");
		
		for (int i = 2; i<N; i++) {
			//usamos la funci�n para saber si i es primo
			if (primo(i)) {
				System.out.print(i + " ");
			}
		}
