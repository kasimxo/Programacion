...
//Escriba un programa que saque por pantalla todos los números primos comprendidos entre dos números introducidos por teclado.
public class Ejercicioveintiuno {
		...
		public static void main(String[] args) {
			...
			while (M<=N ) {
				System.out.println("El segundo valor introducido no es válido.");
