...
//escribir un programa que nos diga cu�l es el numero primo m�s cercano a �l por debajo.
public class Ejercicioocho {
	...
	public static void main(String[] args) {
		...
		if (N == 2) {
			...
			System.out.println("El n�mero 2 es primo, pero no tiene ning�n primo menor que �l mismo.");
